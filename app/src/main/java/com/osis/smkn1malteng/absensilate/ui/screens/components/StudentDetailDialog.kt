    ...
    AlertDialog(
        ...
        text = {
            Column(
                ...
                Text("Kelas: ${student.kelas.display} ${student.jurusan.display}", style = MaterialTheme.typography.bodyMedium)
                Text("No. HP: ${student.phone}", style = MaterialTheme.typography.bodyMedium)
                Text("No. HP Orang Tua: ${student.parentPhone ?: "-"}", style = MaterialTheme.typography.bodyMedium)
